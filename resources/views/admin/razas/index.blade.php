...
<head>
    ...
    <title>PetFriendly - Gestión de Razas</title>
...
<body class="bg-gray-50 font-sans">
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Listar Razas</h1>
            </div>
            ...
            <div class="mb-6 flex justify-between items-center">
                <form method="GET" action="{{ route('admin.razas.index') }}" class="flex gap-4">
                ...
                <a href="{{ route('admin.razas.create') }}"
                    class="px-6 py-2 bg-pet-yellow hover:bg-pet-yellow-dark text-black font-semibold rounded-lg">
                    <i class="fas fa-plus"></i> Agregar nueva raza
                </a>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.razas.destroy', $raza) }}" 
                                              method="POST" 
                                              class="inline"
