...
<head>
    ...
    <title>PetFriendly - Editar Raza</title>
...
<body class="bg-gray-50 font-sans">
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Editar Raza</h1>
            </div>

            <!-- Formulario -->
            <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
                <form action="{{ route('admin.razas.update', $raza) }}" method="POST">
                    @csrf
                    @method('PUT')
...
<div class="mb-4">
    ...
    @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $raza->nombre) }}"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="4"
                                  ...
                                  placeholder="Describe las características de la raza...">{{ old('descripcion', $raza->descripcion) }}</textarea>
                        @error('descripcion')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
