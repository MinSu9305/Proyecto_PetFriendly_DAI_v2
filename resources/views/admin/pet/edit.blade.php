                ...
                <div class="w-full md:w-2/3 p-6">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="description" id="description" rows="4"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:outline-none">{{ old('description', $pet->description) }}</textarea>
                    ...
                    <div class="sticky top-6">
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-gray-400 transition-colors h-64 relative">
                            ...
                            <label for="photo" class="absolute inset-0 flex flex-col items-center justify-center cursor-pointer">
                                <!-- Estado inicial (mostrar foto actual o prompt de subida) -->
                                @if($pet->images && count($pet->images) > 0)
                                    <img id="preview-image" src="{{ Storage::url($pet->images[0]) }}" class="w-full h-full object-cover rounded-lg">
                            ...
                            <div id="change-button" class="absolute bottom-3 left-0 right-0 {{ $pet->images && count($pet->images) > 0 ? '' : 'hidden' }}">
...
<script>
            ...
            .then(data => {
                ...
                if (data && data.length > 0) {
                    data.forEach(raza => {
                        ...
                        // Mantener selección si hay old() data o es la raza actual
    ...
    // Cargar razas al cargar la página si hay una especie seleccionada
