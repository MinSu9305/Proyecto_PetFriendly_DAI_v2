        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-gray-900 mb-2">
                    ...
                    con tu <span class="text-pet-yellow">DONACIÓN</span>
                </h1>
            </div>
            ...
            <form id="donation-form" action="{{ route('user.donations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div id="custom-amount" class="mt-3 hidden">
                        <input type="number" id="custom_amount_input" min="1" step="0.01" placeholder="Ingrese el monto"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pet-yellow focus:border-pet-yellow">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="first_name" class="block text-lg font-semibold text-gray-700 mb-3">Nombres</label>
                    ...
                    <div>
                        <label for="last_name" class="block text-lg font-semibold text-gray-700 mb-3">Apellidos</label>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-700 mb-4">Datos Bancarios:</h3>
                    <div class="space-y-2 text-gray-600">
                        <p><span class="font-medium">Nombre del banco:</span> BCP</p>
                        <p><span class="font-medium">Nombre del Refugio:</span> PetFriendly</p>
                        <p><span class="font-medium">Número de cuenta:</span> 193-2222486-0-52</p>
                        <p><span class="font-medium">Interbancario:</span> 002-193002222486052-12</p>
                    </div>
                </div>

                <!-- Subir Comprobante -->
                <div>
                    <label for="receipt" class="block text-lg font-semibold text-gray-700 mb-3">Subir comprobante</label>
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-pet-yellow transition-colors">
                ...
                <div>
                    ...
                    <textarea id="message" name="message" rows="4" placeholder="Escribir..."
                ...
                <div class="pt-6">
                    <button type="button" onclick="confirmDonation()" 
                            class="w-full py-4 bg-pet-yellow hover:bg-pet-yellow-dark text-black text-xl font-bold rounded-lg transition-colors">
                        Donar
                    </button>
                </div>
            </form>
